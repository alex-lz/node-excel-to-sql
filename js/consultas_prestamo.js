...
const consulta1 = (A,J,K,L) => {
    ...
    VALUES('001', /*num_credito*/'${J}', /*num_producto*/'${K}', '94066531', /*numcte*/'${A}', '                    ', '                    ', '01', '0448', '  ', '   ', '  ', '    ', /*status_cred*/'${L}', 'S', 'N', 'M', 12, EXTEND(MDY(5,12,2012), YEAR to SECOND), EXTEND(MDY(5,12,2013), YEAR to SECOND), '3', '2', 90, 90, '1', 'TASAPRES', '+', 0.000000, 60.750000, 'MORAPRES', 0.000000, '+', 96.750000, '        ', 0.000000, ' ', 0.00, EXTEND(MDY(5,12,2013), YEAR to SECOND), EXTEND(MDY(5,12,2013), YEAR to SECOND), 'S', '  ', '   ', '01', '0.160               ', ' ', '0', '  ', 'M', '                    ', '  ', '     ', 0, 0.00, 0.00, '          ', '          ', NULL);\n\n`
}
